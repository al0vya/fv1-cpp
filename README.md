...
Whether on Linux or Windows, go to the `fv1-cpp` directory/folder in the command line, type in either `python test.py` or `python3 test.py` and press enter to see further instructions on how to run the model.
